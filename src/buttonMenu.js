...
module.exports = async function (client, input, botMessage, buttons, time) {
    ...
    if (!client) return console.log("Error: No client provided.")
    if (!input) return console.log("Error: No message provided.")
    if (!botMessage) return console.log("Error: No bot message provided.")
    if (!buttons) return console.log("Error: No buttons provided.")
    if (!time) return console.log("Error: No time specified.")
